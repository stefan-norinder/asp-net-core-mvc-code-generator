...
namespace CodeGenerator.Lib.CodeGenerators
{
    ...
    public class ApiControllerGenerator : CodeGenerator
    {
        ...
        protected override IEnumerable<TemplateModel> GenerateTemplatesFromModel(CodeGenerationModel model)
        {
            ...
            yield return new TemplateModel { Folder = $"{BaseFolder}{model.Namespace}.{ProjectTypeConstant.Web}/Resources", File = $"ResourcesController.csproj", Content = new ResourcesControllerTemplate(namespaceName).TransformText() };
