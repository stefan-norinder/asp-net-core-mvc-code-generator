...
#line hidden
        ...
        public virtual string TransformText()
        {
            this.Write("@* --------------------------------------------------------------------*@\r\n@* War" +
                    ...
                    "action=\"Index\">@SharedLocalizer.GetLocalizedHtmlString(\"Home\")</a>\r\n            " +
                    "    <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-tar" +
                    "get=\".navbar-collapse\" aria-controls=\"navbarSupportedContent\"\r\n                 " +
                    "       aria-expanded=\"false\" aria-label=\"Toggle navigation\">\r\n                  " +
                    "  <span class=\"navbar-toggler-icon\"></span>\r\n                </button>\r\n        " +
                    "        <div class=\"navbar-collapse collapse d-sm-inline-flex justify-content-be" +
                    "tween\">\r\n                    <ul class=\"navbar-nav flex-grow-1\">\r\n              " +
                    "          <li class=\"nav-item\">\r\n                            <a class=\"nav-link " +
                    "text-dark\" asp-area=\"\" asp-controller=\"Home\" asp-action=\"Index\">@SharedLocalizer" +
                    ".GetLocalizedHtmlString(\"Home\")</a>\r\n                       </li>\r\n             " +
                    "       </ul>\r\n                </div>                \r\n                <div>\r\n   " +
                    "                 <form id=\"changeLanguageFormId\" asp-controller=\"Home\" asp-actio" +
                    "n=\"ToggleCulture\" method=\"post\">\r\n                        <input type=\"hidden\" n" +
                    "ame=\"returnUrl\" value=\"@currentUrl\">\r\n                        <img id=\"iconLangu" +
                    "ageId\" src=\"~/img/icon_language.png\" title=\"@SharedLocalizer.GetLocalizedHtmlStr" +
                    "ing(\"Toggle language\")\" class=\"icon-language\" />\r\n                    </form>\r\n " +
                    "               </div>\r\n            </div>\r\n        </nav>\r\n    </header>\r\n    <d" +
                    "iv class=\"container\">\r\n        <main role=\"main\" class=\"pb-3\">\r\n            @Ren" +
                    "derBody()\r\n        </main>\r\n    </div>\r\n\r\n    <footer class=\"border-top footer t" +
                    "ext-muted\">\r\n        <div class=\"container\">\r\n            &copy; 2022 \r\n        " +
                    "</div>\r\n    </footer>\r\n    <script src=\"~/lib/jquery/dist/jquery.min.js\"></scrip" +
                    "t>\r\n    <script src=\"~/lib/bootstrap/dist/js/bootstrap.bundle.min.js\"></script>\r" +
                    "\n     <script src=\"https://cdn.datatables.net/1.12.0/js/jquery.dataTables.min.js" +
                    "\"></script>\r\n    <script src=\"https://cdn.datatables.net/buttons/2.2.2/js/dataTa" +
                    "bles.buttons.min.js\"></script>\r\n    <script src=\"https://cdn.datatables.net/butt" +
                    "ons/2.2.2/js/buttons.html5.min.js\"></script>\r\n    <script src=\"https://cdn.datat" +
                    "ables.net/buttons/2.2.2/js/buttons.colVis.min.js\"></script>\r\n    <script src=\"ht" +
                    "tps://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js\"></script>\r\n    <s" +
                    "cript src=\"https://cdn.datatables.net/buttons/2.2.3/js/buttons.print.min.js\"></s" +
                    "cript>\r\n    <script src=\"~/js/site.js\" asp-append-version=\"true\"></script>\r\n    " +
                    "<script src=\"~/js/custom-site.js\" asp-append-version=\"true\"></script>\r\n    @awai" +
                    "t RenderSectionAsync(\"Scripts\", required: false)\r\n</body>\r\n</html>\r\n\r\n");
