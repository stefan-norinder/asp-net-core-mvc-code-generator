...
namespace CodeGenerator.Lib.Templates
{
    ...
    #line 1 "C:\Users\StefanAdmin\code2\asp-net-core-mvc-code-generator\CodeGenerator.Lib\Templates\HttpServiceBaseTemplate.tt"
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 6 "C:\Users\StefanAdmin\code2\asp-net-core-mvc-code-generator\CodeGenerator.Lib\Templates\HttpServiceBaseTemplate.tt"
            ...
            #line 14 "C:\Users\StefanAdmin\code2\asp-net-core-mvc-code-generator\CodeGenerator.Lib\Templates\HttpServiceBaseTemplate.tt"
            ...
            this.Write(".Logic.Http\r\n{\r\n    public interface IHttpService<T>\r\n    {\r\n        Task<T> Get(" +
                    ...
                    "BearerToken(string token);\r\n    }\r\n    public class HttpService<T> : IHttpServic" +
                    "e<T>\r\n    {\r\n        protected IHttpClient client;\r\n        protected readonly I" +
                    "Logger logger;\r\n\r\n        public HttpService(IHttpClient client,\r\n            IL" +
                    "ogger<HttpService<T>> logger)\r\n        {\r\n            this.client = client;\r\n   " +
                    "         this.logger = logger;\r\n        }\r\n\r\n        public virtual async Task<T" +
                    "> Get(string url, string id)\r\n        {\r\n            try\r\n            {\r\n       " +
                    "         var uri = CombineUrls(url, id);\r\n                var response = await c" +
                    "lient.Get(uri);\r\n                response.CheckStatus();\r\n                logger" +
                    ".LogDebug($\"Get data from {uri}: {response.Content}\");\r\n                return J" +
                    "sonConvert.DeserializeObject<T>(response.Content);\r\n            }\r\n            c" +
                    "atch (Exception e)\r\n            {\r\n                logger.LogError(e, e.Message)" +
                    ";\r\n                throw;\r\n            }\r\n        }\r\n\r\n        public virtual as" +
                    "ync Task<IEnumerable<T>> Get(string url)\r\n        {\r\n            try\r\n          " +
                    "  {\r\n                var response = await client.Get(new Uri(url));\r\n           " +
                    "     response.CheckStatus();\r\n                logger.LogDebug($\"Get data from {u" +
                    "rl}: {response.Content}\");\r\n                return JsonConvert.DeserializeObject" +
                    "<IEnumerable<T>>(response.Content);\r\n            }\r\n            catch (Exception" +
                    " e)\r\n            {\r\n                logger.LogError(e, e.Message);\r\n            " +
                    "    throw;\r\n            }\r\n        }\r\n\r\n        public virtual async Task<T> Pos" +
                    "t(string url, T model)\r\n        {\r\n            try\r\n            {\r\n             " +
                    "   var content = JsonConvert.SerializeObject(model);\r\n                var respon" +
                    "se = await client.Post(new Uri(url), content);\r\n                response.CheckSt" +
                    ...
                    "nse.CheckStatus();\r\n                logger.LogDebug($\"Put data from {uri}: {resp" +
                    "onse.Content}\");\r\n            }\r\n            catch (Exception e)\r\n            {\r" +
                    "\n                logger.LogError(e, e.Message);\r\n                throw;\r\n       " +
                    "     }\r\n        }\r\n\r\n        public virtual async Task Delete(string url, string" +
                    " id)\r\n        {\r\n            try\r\n            {\r\n                var uri = Combi" +
                    "neUrls(url, id);\r\n                var response = await client.Delete(uri);\r\n    " +
                    "            response.CheckStatus();\r\n                logger.LogDebug($\"Delete da" +
                    "ta from {uri}\");\r\n            }\r\n            catch (Exception e)\r\n            {\r" +
                    "\n                logger.LogError(e, e.Message);\r\n                throw;\r\n       " +
