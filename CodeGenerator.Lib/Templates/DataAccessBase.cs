...
namespace CodeGenerator.Lib.Templates
{
    ...
    #line 1 "C:\Users\StefanAdmin\code2\asp-net-core-mvc-code-generator\CodeGenerator.Lib\Templates\DataAccessBase.tt"
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 7 "C:\Users\StefanAdmin\code2\asp-net-core-mvc-code-generator\CodeGenerator.Lib\Templates\DataAccessBase.tt"
            ...
            #line 9 "C:\Users\StefanAdmin\code2\asp-net-core-mvc-code-generator\CodeGenerator.Lib\Templates\DataAccessBase.tt"
            ...
            this.Write(".Logic.DataAccess\r\n{\r\n    public partial interface IDataAccess<T>\r\n    {\r\n       " +
                    ...
                    "   {\r\n            return await db.LoadSingularData<T, dynamic>(sql, new { Id = i" +
                    "d });\r\n        }\r\n\r\n        protected async Task<T> ExecuteSelectSingle(string s" +
                    "ql)\r\n        {\r\n            return await db.LoadSingularData<T, dynamic>(sql, ne" +
                    "w { });\r\n        }\r\n\r\n        protected async Task<List<T>> ExecuteSelectMany(st" +
                    "ring sql)\r\n        {\r\n            return await db.LoadData<T, dynamic>(sql, new " +
                    "{ });\r\n        }\r\n\r\n        #region private\r\n\r\n        private async Task<bool> " +
                    "HasIdentityColumn()\r\n        {\r\n            var sql = @$\"select b.name as Identi" +
                    ...
                    "ult = await ExecuteSelectMany(sql);\r\n            return result.Any();\r\n        }" +
